...
import { BlobsComponentStyles } from './blobs-wc.styles.js';

export class BlobsComponent extends LitElement {
  ...
  render() {
    return html`
      <div
        class="blob"
        style="fill: ${this.color ? this.color : 'rebeccapurple'}"
      >
